export const NavBar = () => {
  return (
    <nav className="fixed top-0 w-screen rounded border-b bg-white">
      <div className="container mx-auto  px-4 py-2 flex flex-wrap items-center justify-between">
        <a href="/logo.svg" className="flex items-center">
          ...
          <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">entella</span>
        </a>
        <button
